...
The historical implementation of this pattern lived on the `probe-ff846709`
branch of a linkml-map checkout (row-flow counters + RSS-vs-tracemalloc memory
attribution); it's a reference for the shape, not something to re-adopt wholesale.
