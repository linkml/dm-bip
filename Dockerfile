...
RUN git clone --depth 1 --branch v1.2.0 https://github.com/RTIInternational/NHLBI-BDC-DMC-HM.git && \
    git clone --depth 1 --branch fix/aric-chr-20260328 https://github.com/RTIInternational/NHLBI-BDC-DMC-HV.git;


    #    git clone --depth 1 --branch fix/jhs-chr-20260328 https://github.com/RTIInternational/NHLBI-BDC-DMC-HV.git;
#   git clone --depth 1 --branch feature/spiromics https://github.com/RTIInternational/NHLBI-BDC-DMC-HV.git;
