...
RUN if [ "$BDC_PULL_LATEST" = "true" ]; then \
      ...
      git clone --depth 1 --branch v1.1.0 https://github.com/RTIInternational/NHLBI-BDC-DMC-HM.git && \
      git clone --depth 1 --branch 2026.03-2-rc1 https://github.com/amc-corey-cox/bdc-harmonized-variables.git; \
    fi
