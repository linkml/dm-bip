...
- **Target schema:** [`toy_data/target-schema.yaml`](toy_data/target-schema.yaml)
  (shared target schema, now includes `target_sex_enum` with OMOP:8507/OMOP:8532 on `Person.gender`).
